...
Status: Active. Distilled from the root-cause-first discipline in
...
2. **Read before inferring** (§3): the spec, the implementation, the
...
- If a debugging session repeatedly needed a step this skill omits, add
  it while context is fresh (skills-lifecycle §5).
