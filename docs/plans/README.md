...
| 2026-07-28-guidance-gates-plan | 2026-07-28 | Landed the corpus self-check gates (check-doc-paths, coalesce-check, bootstrap adaptation layer) | bin/check-doc-paths, bin/coalesce-check, bin/bootstrap-agent-theory (adaptation layer); CI wiring later in .github/workflows/gates.yml (corrected 2026-08-07 after post-deletion verification; was: misattributed to CHANGELOG 2026-08-06) | `2415252` |
