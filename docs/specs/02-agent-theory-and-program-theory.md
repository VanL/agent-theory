...
Verification: Consistency with `docs/program-theory.md` (hub account) and
`01-development-documentation-operating-model.md` [DOM-2]/ [DOM-3].
...
| **This repository** | The reference operating model and starter corpus for applying the discipline |
...
| **This hub repository** | The guidance system itself (process + meta-theory) |
...
| Need | Go to |
|------|--------|
| This repository's identity account (hub) | `docs/program-theory.md` |
| Product theory after bootstrap | Replace `docs/program-theory.md` via `skills/crystallize-program-theory/SKILL.md` |
| How agents load context / taxonomy | `01-development-documentation-operating-model.md` [DOM-2], [DOM-3] |
...
- `docs/plans/2026-07-30-program-theory-and-module-theory.md`
